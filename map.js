...
var locationArray = [
    {   name: "Ikebukuro",
        x: "1450",
        y: "258",
        reality: "Ikebukuro to me is the paradise of anime and the best place to hang out with friends. There locates the world’s largest anime goods shop, Animate. We like to shop there. There are also many street games stores, such as Gigo, there. We loved to enjoy claw machines there."
            + "<br><img class=\"horizontal\" src = \"image/ikebukuro_real_1.png\" alt=\"Ikebukuro real image\" />"
            + "<img class=\"horizontal\" src = \"image/ikebukuro_real_2.png\" alt=\"Ikebukuro real image\" />"
            + "<br><img class=\"horizontal\" src = \"image/ikebukuro_real_6.png\" alt=\"Ikebukuro real image\" />"
            + "<img class=\"horizontal\" src = \"image/ikebukuro_real_7.png\" alt=\"Ikebukuro real image\" />"
            + "<br><br>"
            + "One important shopping mall located in Ikebukuro is the Sunshine City. I like the food there. There is one fantastic restaurant serving Omelet rice, called \“Tamago to Watashi\”. I also liked Wako’s Nabe Gohan, even though they sometimes go a bit too salty."
            + "<br><img class=\"horizontal\" src = \"image/ikebukuro_real_3.png\" alt=\"Ikebukuro real image\" />"
            + "<img class=\"horizontal\" src = \"image/ikebukuro_real_8.png\" alt=\"Ikebukuro real image\" />"
            + "<br><br>"
            + " Sunshine city also holds many anime events. My friends and I went to one anime custom exhibition here. It is really enjoyable to see stuffs that we like."
            + "<br><img class=\"horizontal\" src = \"image/ikebukuro_real_4.png\" alt=\"Ikebukuro real image\" />"
            + "<img class=\"horizontal\" src = \"image/ikebukuro_real_10.png\" alt=\"Ikebukuro real image\" />"
            + "<br><br>"
            + "Another thing about Ikebukuro to me is that it is not wallet friendly. The shops there are so amazing. Every time I went there, I tend to spend over 20,000 yen on buying anime related goods." 
            + "<br><img class=\"horizontal\" src = \"image/ikebukuro_real_9.png\" alt=\"Ikebukuro real image\" />"
            + "<img class=\"horizontal\" src = \"image/ikebukuro_real_5.png\" alt=\"Ikebukuro real image\" />"
            + "<br><br>"
        ...
        machine:  "Ikebukuro, nestled in the heart of Tokyo, pulsates with a vibrant energy that is uniquely its own. As one of the city's major commercial and entertainment hubs, Ikebukuro embodies a dynamic fusion of traditional Japanese culture and modern urban lifestyle. The space of Ikebukuro is characterized by its bustling streets, towering skyscrapers, and a kaleidoscope of neon lights that illuminate the night sky."
            + "<br><img class=\"horizontal\" src = \"image/ikebukuro_machine_1.png\" alt=\"Ikebukuro machine image\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/ikebukuro_machine_2.png\" alt=\"Ikebukuro machine image\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/ikebukuro_machine_3.png\" alt=\"Ikebukuro machine image\" />"
            + "<br><br>"
    ...
    {   name: "Shinjuku",
        x: "1292",
        y: "1022",
        reality: "Aside from Shibuya, I also liked to shop cloth at Shinjuku, especially the Lumine store. I can spent a whole day just shopping around, eating around and play around at Shinjuku. It is a really good place to relax myself."
            + "<br><img class=\"horizontal\" src = \"image/shinjuku_real_1.jpeg\" alt=\"Shinjuku real image\" />"
            + "<img class=\"horizontal\" src = \"image/shinjuku_real_3.jpeg\" alt=\"Shinjuku real image\" />"
            + "<br><br>"
            + "However, aside from the fantastic stores, my parents always talked to me that not to go to Kabukicho at night, especially the Ichiban-gai. There locates a big red light districts, and a lot of host clubs are there. Even near night times (around 6pm) when you talk near Kabukicho, you can be greet by hosts to their store. They are generally more difficult person than that in Akihabara."
            + "<br><img class=\"horizontal\" src = \"image/shinjuku_real_2.jpeg\" alt=\"Shinjuku real image\" />",
        machine: "Shinjuku, a bustling district in Tokyo, Japan, is a vibrant and dynamic space that encapsulates the essence of modern Japanese urban life. As one of Tokyo's major commercial and entertainment hubs, Shinjuku offers a kaleidoscope of experiences, from towering skyscrapers to narrow alleyways filled with izakayas (Japanese pubs) and bustling crowds of people."
            + "<br><img class=\"horizontal\" src = \"image/shinjuku_machine_1.png\" alt=\"Shinjuku machine image1\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/shinjuku_machine_2.png\" alt=\"Shinjuku machine image2\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/shinjuku_machine_3.png\" alt=\"Shinjuku machine image3\" />"
            + "<br><br>"
    ...
    {   name: "Shibuya",
        x: "1290",
        y: "1600",
        reality: "When thinking about my memory of Shibuya, my experience with it is that it is a fashion place. There are a lot of fashion stores in Shibuya, including Shibuya 109 and Parco. I like the Parco there. I like the style of cloth (mostly Jirai style) in Shibuya 109, but they sometimes fits more to shorter people. I feel hard to find suitable size there. So I shop more for that style of cloth at Lumine in Shinjuku instead."
            + "<br><img class=\"horizontal\" src = \"image/shibuya_real_7.jpeg\" alt=\"Shibuya real image\" />"
            + "<img class=\"horizontal\" src = \"image/shibuya_real_6.jpeg\" alt=\"Shibuya real image\" />"
            + "<br><br>"
            + "You can see advertising cars driving across every place. There are also big advertisements in Shibuya Stations. Sometimes it will show anime related stuff, where fans will go and take photos of them."
            + "<br><img class=\"horizontal\" src = \"image/shibuya_real_5.png\" alt=\"Shibuya real image\" />"
            + "<img class=\"horizontal\" src = \"image/shibuya_real_1.png\" alt=\"Shibuya real image\" />"
            + "<br><br>"
            + " There are also focus ramen shops in Shibuya, and also places to each Matcha desserts. The shop is called \"Matcha Tokyo\" and I would really recommend it. It is the best Matcha ice I have ever had."
            + "<br><img class=\"horizontal\" src = \"image/shibuya_real_2.png\" alt=\"Shibuya real image\" />"
            + "<img class=\"horizontal\" src = \"image/shibuya_real_4.png\" alt=\"Shibuya real image\" />"
            + "<br><br>"
            + " One thing special about Shibuya is that it has the biggest Tower Records store, a place selling albums. You can also find signatures of famous singers there. Below is the signature of Fuji Kaze, whom music I really enjoy."
            + "<br><img class=\"horizontal\" src = \"image/shibuya_real_3.png\" alt=\"Shibuya real image\" />",
        machine: "Shibuya, one of Tokyo's most vibrant and bustling districts, is a captivating blend of modernity and tradition, where the pulse of the city beats strongest. Located in the heart of Tokyo, Shibuya is renowned for its energetic atmosphere, cutting-edge fashion, and vibrant nightlife, making it a magnet for both locals and tourists alike."
            + "<br><img class=\"horizontal\" src = \"image/shibuya_machine_1.png\" alt=\"Shibuya machine image\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/shibuya_machine_2.png\" alt=\"Shibuya machine image\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/shibuya_machine_3.png\" alt=\"Shibuya machine image\" />"
            + "<br><br>"
    ...
    {   name: "Harajuku",
        x: "1318",
        y: "1414",
        reality: "Harajuku is also a place about fashion. You can buy good cloth there. But more importantly, I often go there to buy cosmetics because there locates the largest @cosme store, a Japanese store that tells collections of cosmetics just as Sephora. It always has the fullest collections. "
            + "<br><img class=\"horizontal\" src = \"image/harajuku_real_1.jpeg\" alt=\"Harajuku real image\" />"
            + "<img class=\"horizontal\" src = \"image/harajuku_real_3.jpeg\" alt=\"Harajuku real image\" />"
            + "<br><br>"
            + "I also always go to Harajuku, especially Omotesando, for my haircut. Fashionists in Omotesando always has a good taste."
            + "<br><img class=\"horizontal\" src = \"image/harajuku_real_5.jpeg\" alt=\"Harajuku real image\" />"
            + "<img style=\"object-fit: cover; height: 250px;\" src = \"image/harajuku_real_2.jpg\" alt=\"Harajuku real image\" />"
            + "<img style=\"object-fit: cover; height: 250px;\" src = \"image/harajuku_real_7.jpg\" alt=\"Harajuku real image\" />",
        machine: "Harajuku, nestled within the bustling city of Tokyo, is a vibrant and eclectic district that pulsates with energy and creativity. Renowned for its avant-garde fashion, quirky street style, and unique subcultures, Harajuku is a melting pot where tradition meets innovation, and where the past harmonizes with the present. My memory of Harajuku paints a picture of a place where every corner seems to exude a sense of excitement and individuality."
            + "<br><img class=\"horizontal\" src = \"image/harajuku_machine_1.png\" alt=\"Harajuku machine image1\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/harajuku_machine_2.png\" alt=\"Harajuku machine image2\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/harajuku_machine_3.png\" alt=\"Harajuku machine image3\" />"
            + "<br><br>"
    ...
    {   name: "Akihabara",
        x: "2420",
        y: "853",
        reality: "Though Akihabara is usually referred as the best place to get anime related goods, I don’t really go to Akihabara very often. Akihabara has more stuff on anime for males, while Ikebukuro has more stuff on anime for females. I found less stuff on anime IP I like in Akihabara but more in Ikebukuro instead. But Akihabara is also a good place to seek stuff that are sold out in stores in Ikebukuro, simply because less people went there to shop goods of anime for females."
            + "<br><img class=\"vertical\" src = \"image/akihabara_real_1.png\" alt=\"Akihabara real image\" />"
            + "<img class=\"vertical\" src = \"image/akihabara_real_3.png\" alt=\"Akihabara real image\" />"
            + "<br><br>"
            + " Akihabara is really a good place for street games. I believe there are more street game machines than any where else at Tokyo. I enjoyed the games there."
            + "<br><img class=\"vertical\" src = \"image/akihabara_real_2.png\" alt=\"Akihabara real image\" />"
            + "<img class=\"vertical\" src = \"image/akihabara_real_4.png\" alt=\"Akihabara real image\" />"
            + "<br><br>"
            + "Honestly speaking, I don’t like Akihabara that much. There are many deacon or maid cafes at Akihabara, where some people do enjoy a lot. However, every time I went to Akihabara with friends, if you address up a bit, there would be crazy people greeting you to their store. Even when you rejected them, they can chase you along the street, which sometimes goes really annoying. Anyway, it could be a bit concern for girls to walk alone at Akihabara during night times.",
        machine: "Akihabara, located in the heart of Tokyo, Japan, is a vibrant and bustling district renowned worldwide as the epicenter of otaku culture and electronics. Known colloquially as \"Akiba,\" it's a kaleidoscope of neon lights, towering billboards, and a constant hum of activity that engulfs visitors in a sensory overload. The district is a melting pot of modernity and tradition, where cutting-edge technology intersects with the nostalgic charm of Japan's pop culture."
            + "<br><img class=\"horizontal\" src = \"image/akihabara_machine_1.png\" alt=\"Akihabara machine image1\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/akihabara_machine_2.png\" alt=\"Akihabara machine image2\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/akihabara_machine_3.png\" alt=\"Akihabara machine image3\" />"
            + "<br><br>"
    ...
    {   name: "Roppongi",
        x: "1819",
        y: "1545",
        reality: "When talking about Roppongi, the first thing came to my mind is absolutely the Tokyo Tower. It is a pretty beautiful place, where you can see a bird view of Tokyo from there. During holidays, Tokyo Tower will also be decorated with different lights. We went during Christmas times, so the Tower also gets its Christmas custom. So as the road at Roppongi Keyakizaka at Roppongi Hills. The streets are decorated with lights and you can see Tokyo Tower from there (always the best place to obverse Tokyo Tower), which is really beautiful. There are good western style restaurants at Roppongi Hills."
            + "<br><img class=\"vertical\" src = \"image/roppongi_real_1.png\" alt=\"Roppongi real image\" />"
            + "<img class=\"vertical\" src = \"image/roppongi_real_2.png\" alt=\"Roppongi real image\" />"
            + "<br><br>"
            + "Roppongi is really a place of art. It has artistic views and also locates two art museums, Mori Art Museum and The National Art Center Tokyo. The art exhibitions there are amazing. There also locates one big Tsutaya bookstore. I don’t really been there a lot, generally because Roppongi is kinds of crowded. But I like the atmosphere there and it the bookstore is really located at a nice place."
            + "<br><img class=\"horizontal\" src = \"image/roppongi_real_5.png\" alt=\"Roppongi real image\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/roppongi_real_3.png\" alt=\"Roppongi real image\" />"
            + "<img class=\"horizontal\" src = \"image/roppongi_real_4.png\" alt=\"Roppongi real image\" />",
        machine: "Roppongi, located in the heart of Tokyo, is a vibrant and dynamic district that pulsates with energy day and night. As one of Tokyo's premier entertainment and nightlife hubs, Roppongi offers a diverse array of experiences that cater to a wide range of tastes and interests."
            + "<br><img class=\"horizontal\" src = \"image/roppongi_machine_1.png\" alt=\"Roppongi machine image1\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/roppongi_machine_2.png\" alt=\"Roppongi machine image2\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/roppongi_machine_3.png\" alt=\"Roppongi machine image3\" />"
            + "<br><br>"
    ...
    {   name: "Ginza",
        x: "2322",
        y: "1317",
        reality: "Ginza and Roppongi are similar styled places. The only difference is that Roppongi might contains more artistic elements but Ginza is more commercial. My family often went shopping around Ginza. It contains more stores suitable for every age."
            + "<br><img class=\"horizontal\" src = \"image/ginza_real_5.jpeg\" alt=\"Ginza real image\" />"
            + "<br><br>"
            + "There locates a super big Loft, which is a grocery store but 6 to 7 floors high, and it almost contains everything. From snacks to shampoo to stationary, you can find almost everything you want. I really like the stationary there. They have new stuffs coming out each season, like sakura stickers when the blossom season comes. They are really cute and pretty."
            + "<br><img class=\"horizontal\" src = \"image/ginza_real_3.png\" alt=\"Ginza real image\" />"
            + "<img class=\"horizontal\" src = \"image/ginza_real_4.png\" alt=\"Ginza real image\" />"
            + "<br><br>"
            + "Another important space forming my memory of Ginza is the Seikadou, which is a dessert shop selling dorayaki-style desserts made from fruits. They are super tasty. I always bought a lot of them for my breakfast."
            + "<br><img class=\"horizontal\" src = \"image/ginza_real_1.png\" alt=\"Ginza real image\" />"
            + "<br><br>"
            + "Ginza also has my favorite eel rice restaurant called “Hitsumabushi”. It is a traditional style Japanese restaurant located at Mitsukoshi Ginza. I often eat with my family and friends there."
            + "<br><img class=\"horizontal\" src = \"image/ginza_real_2.png\" alt=\"Ginza real image\" />",
        machine: "Ginza, located in the heart of Tokyo, is a vibrant and bustling district renowned for its upscale shopping, dining, and entertainment options. As one of Tokyo's most iconic neighborhoods, Ginza exudes an air of sophistication and elegance that draws locals and tourists alike."
            + "<br><img class=\"horizontal\" src = \"image/ginza_machine_1.png\" alt=\"Ginza machine image1\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/ginza_machine_2.png\" alt=\"Ginza machine image2\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/ginza_machine_3.png\" alt=\"Ginza machine image3\" />"
            + "<br><br>"
    ...
    {   name: "Home",
        x: "1519",
        y: "1755",
        reality: "Because Perec Georges wrote sometime about his room and apartment, I would like to also wrote something about my home in Tokyo. It is located in the Shibuya but somehow also near Minato. "
            + "<br><br>"
            + "I started to think of what is special for a home in Tokyo to be other than my home in Shanghai where I lived most. I then realized there is really nothing super special there. It has a rooms, living rooms, a kitchen, bathrooms and etc., and that’s pretty much it. The house was decorated by the exact same people. So the style of the rooms are pretty much the same. It is surrounded by heavy traffic, but so does Shanghai. And for the shops nearby, you can buy what you want there, and so as many shops in the world. "
            + "<br><br>"    
            + "Talking about my room. It has a bed, a desk, a chair and several shelf. I put posters on the wall just the same as what I did to my walls for my current room. Then I started to think about what is actually the difference between them. Walls are endowed meanings and affection by the posters, but where they exactly located is not that important. If same posters are put to different walls, they still can be same walls to me to some extent."
            + "<br><br>"
            + "The only difference in my memory is that I tend to have more free time at home in Tokyo. But then I realized it is because that’s when I was in primary school and not really much study pressure there. The location of the room still does not matter but time does."
            + "<br><br>"
            + "It kinds correspond to Perec Georges idea of spaces, where is describing spaces using memory and experience, but physical location can matter less."
            + "<br><br>"
            + "P.S. The map does not show the act location of my home. And sorry I don’t really have photos of it :) ",
        machine: "As you enter the home located in Tokyo, you're immediately struck by the minimalist yet functional design. The entrance area is compact but efficiently organized, with a shoe rack neatly arranged to the side and a small space for umbrellas. Sliding doors adorned with delicate shoji screens lead into the main living area, creating a sense of openness and flow."
            + "<br><img class=\"horizontal\" src = \"image/home_machine_1.png\" alt=\"Home machine image1\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/home_machine_2.png\" alt=\"Home machine image2\" />"
            + "<br><br>"
            ...
            + "<br><img class=\"horizontal\" src = \"image/home_machine_3.png\" alt=\"Home machine image3\" />"
            + "<br><br>"
...
function loadSize() {
    ...
    resultID.style.top = console_height / 2 - 300 + "px";
    resultID.style.width = "600px";
    resultID.style.height = "600px";
...
function search() {
    for(var i = 0; i < locationArray.length; i++) {
        if(locationArray[i].name == searchboxID.value) {
            ...
            setTimeout("pop();",1201);
            setTimeout("switchID.value = \"Switch to Machine\";", 1201);
            setTimeout("textID.innerHTML = locationArray[cur_location_i].reality;", 1201);
        }
    }
}
...
function pop() {
    ...
    pinID.src = "pin.png";
    locID.innerHTML = cur_location + " - Reality"; 
}
...
function switch_button() {
    if(switchID.value == "Switch to Machine") {
        ...
        locID.innerHTML = cur_location + " - Machine"; 
        switch_machine();
    }
    else {
